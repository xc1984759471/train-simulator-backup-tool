...
#### Left Panel: Routes and Scenarios Tree
- **Search Box**: Enter route or scenario names at the top for real-time search and filtering
- Display all installed routes
- Click routes to expand and view scenario lists
- Scenarios display Chinese names (parsed from XML files)
- Search function supports fuzzy matching, automatically expands routes containing matching content

#### Right Panel: Backup Management
- **Scenario Information**: Display name and path of currently selected scenario
- **Backup List**: Show all backup files for the scenario
- **Operation Buttons**:
  - **Create Backup**: Create new backup for current scenario
  - **Restore Backup**: Restore selected backup to game save
  - **Delete Backup**: Delete selected backup file

### Operation Flow

#### Create Backup
1. Select the scenario to backup in the left tree
2. Click "Create Backup" button
3. Program will automatically create backup file with timestamp

#### Restore Backup
1. Select the scenario to restore
2. Select the backup to restore from the right backup list
3. Click "Restore Backup" button
4. Click "Yes" to confirm operation in the confirmation dialog

#### Delete Backup
1. Select scenario and backup to delete
2. Click "Delete Backup" button
3. Click "Yes" to confirm deletion in the confirmation dialog
